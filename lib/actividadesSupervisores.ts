...
export const areasActividad = ["POSCOSECHA", "INGRESO PERSONAL", "PRODUCCION", "SG-SST", "ADMINISTRACION", "MIPE", "MIRFE", "MANTENIMIENTO", "ALMACEN", "DEFINE SIG", "CONTRATISTAS", "FINCAS", "FINCAS OCCIDENTE", "FINCAS NORTE", "OFICINA GB", "CUARTO FRIO DE RECEPCIÓN", "LOCKERS", "CASA", "CONSULTORIO"];
