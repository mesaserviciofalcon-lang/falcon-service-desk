...
export default function ProgramacionActividadesPanel({ ventanaAbierta, etiquetaMes, etiquetaVentana, etiquetaUltimoDiaVentana, actividades, ocupadas, areas }: { ventanaAbierta: boolean; etiquetaMes: string; etiquetaVentana: string; etiquetaUltimoDiaVentana: string; actividades: Actividad[]; ocupadas: Ocupada[]; areas: string[] }) {
