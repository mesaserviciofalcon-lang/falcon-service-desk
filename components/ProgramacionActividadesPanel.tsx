...
export default function ProgramacionActividadesPanel({ ventanaAbierta, puedeControlar, etiquetaMes, etiquetaVentana, etiquetaUltimoDiaVentana, actividades, ocupadas, areas }: { ventanaAbierta: boolean; puedeControlar: boolean; etiquetaMes: string; etiquetaVentana: string; etiquetaUltimoDiaVentana: string; actividades: Actividad[]; ocupadas: Ocupada[]; areas: string[] }) {
